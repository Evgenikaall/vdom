    ...
    return (
        <section className="w-[85%] max-lg:w-full flex justify-center flex-col my-10 mx-auto items-center">
            ...
            <div className="flex justify-around w-[90%] max-md:flex-col items-center">
                <img src={map} className='w-[60%]' alt="Map of delivery"/>
                <div className="flex md:flex-col max-md:w-[90%] w-[25%] pt-[10%] max-md:justify-between">
                    <div className="flex flex-col pb-10 max-md:items-center">
...
function DeliveryMethodItem() {
    return (
        <div className="flex flex-col mb-5 max-md:items-center">
            ...
            <p className="text-md text-gray-600 font-thin max-md:text-center">Lorem ipsum Lorem ipsumLorem ipsumLorem ipsum Lorem ipsum</p>
        </div>
    );
}
