    ...
    return (
        <section className="flex justify-center mt-6 px-5">
            <div className="w-full border-2 border-gray-500 rounded-t-4.5rem rounded-b-4.5rem">
                <div className="h-full flex flex-col justify-around items-center py-10 2xl:w-[90%] xl:w-[90%] lg:w-[90%] mx-auto">
                    ...
                    <div className="flex justify-between flex-wrap py-5 max-lg:flex-col max-lg:w-[80%] w-full">
                        <WorkingAreaSide/>
                        <WorkingAreaSide/>
                        <WorkingAreaSide/>
                        <WorkingAreaSide/>
...
function WorkingAreaSide() {
    return (
        <div className="rounded bg-main-color px-8 py-12 mb-5 flex justify-around max-lg:justify-center items-center rounded-t-[2.7rem] rounded-b-[2.7rem] w-[100%] lg:w-[24%]">
